...
class SDLW {
public:
    SDLW(std::string window_title, unsigned int window_size_percent, Image *image);
    ~SDLW();
...
private:
    static SDL_PixelFormatEnum bytes_per_pixel_to_sdl_format(unsigned int bytes_per_pixel);
