...
private:
    ...
    static constexpr std::array<IHDR::Color_type, 5> SUPPORTED_TYPES = { IHDR::Color_type::RGB, IHDR::Color_type::RGBA, IHDR::Color_type::PALETTE, IHDR::Color_type::GREYSCALE, IHDR::Color_type::GREYSCALE_APLHA };
    ...
    std::vector<unsigned char> grayscale_to_rgb(std::vector<unsigned char> &grayscale);

    void decode_line(unsigned char *destination, unsigned char *source, int line_number) const;
